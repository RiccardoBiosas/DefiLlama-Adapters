...
async function eth() {
  const opium = await utils.fetchURL('https://static.opium.network/data/opium-addresses.json');
...
async function polygon() {
  const opium = await utils.fetchURL('https://static.opium.network/data/opium-addresses-polygon.json');
...
async function bsc() {
  const opium = await utils.fetchURL('https://static.opium.network/data/opium-addresses-bsc.json');
